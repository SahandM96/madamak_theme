...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = 'cafecommerce_daa9d8a7d981d987daa9d8a7d98_0bd4b8d2e997c6303631_20200205153816_archive.zip';
    const ARCHIVE_SIZE       = '159535026';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '0bd4b8d-05153816';
    const VERSION            = '3.8.6.2';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.6.2==');
        $this->log('----------------------------------------------------');
