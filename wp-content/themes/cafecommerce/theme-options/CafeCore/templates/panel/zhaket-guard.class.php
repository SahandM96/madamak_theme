...
class Cafecommerce_SDK {
     ...
     * If you want add an interrupt in your plugin or theme simply can use this static method: Cafecommerce_SDK::is_activated
...
add_action('init', 'cafecommerce_guard_init');
/**
 * Initialize function for class and hook it to wordpress init action
 */
function cafecommerce_guard_init() {
	$settings = [
		'name'          => 'cafecommerce',
		'slug'          => 'cafe-commerce',
		...
		'product_token' => '', // Get it from here: https://zhaket.com/dashboard/licenses/
		'option_name'   => 'cafecommerce_tariyaweb_version1_settings'
	];
	Cafecommerce_SDK::instance($settings);
}